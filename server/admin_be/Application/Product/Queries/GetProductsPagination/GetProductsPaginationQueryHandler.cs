...
namespace Application.Product.Queries.GetProductsPagination
{
    public class GetProductsPaginationQuery : IRequest<ResponDataDto>
    {
        public int page_size { get; set; }
        public int page_number { get; set; }
    }
    public class GetProductsPaginationQueryHandler(IDbConnection dbConnection) : IRequestHandler<GetProductsPaginationQuery, ResponDataDto>
    {
        public async Task<ResponDataDto> Handle(GetProductsPaginationQuery request, CancellationToken cancellationToken)
        {
            var productData = await dbConnection.QueryMultipleAsync
            (
                "sp_get_products_pagination",
                new
                {
