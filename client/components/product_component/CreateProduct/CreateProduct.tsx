        ...
        <div className="w-[1000px] p-5 rounded-lg bg-white">
            ...
            <div className="border border-solid border-gray-300 mt-3 min-h-[200px]">
                ...
                <div className="flex flex-col gap-3 py-3">
                    {payload.list_product_detail.length > 0 &&
                        payload.list_product_detail.map((pd, idx) => (
                            <div key={idx} className="grid grid-cols-8 items-center text-center pr-2">
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        setPayload({
                                            ...payload,
                                            list_product_detail: payload.list_product_detail.filter(
                                                (_, index) => index !== idx,
                                            ),
                                        })
                                    }
                ...
                <div className="w-[600px] p-5 rounded-lg bg-white">
                    ...
                    <div className="flex flex-col gap-3 mt-3 bg-gray-100 p-4 rounded-lg shadow-md">
                        <div className="flex flex-row items-center gap-2">
                            <label
                                ...
                                className="block w-[80px] text-sm font-semibold text-gray-700"
                            >
                                {' '}
                                Kích cỡ
                            </label>
                        ...
                        <div className="flex-1 flex items-center gap-2">
                            ...
                            <button
                                onClick={() => {
                                    setPayLoadProdetail({
                                        ...payLoadProdetail,
                                        sizes: [...payLoadProdetail.sizes, size],
                                    });
                                    setSize('');
                                }}
                    ...
                    >
                        ...
                        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            ...
                            {payLoadProdetail.image && (
                                <Image src={payLoadProdetail.image} width={120} height={120} alt="product" />
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            className="bg-blue-500 text-white rounded-lg px-5 py-2 mt-5"
                        >
                            Thêm
                        </button>
                    </div>
